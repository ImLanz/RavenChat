...
import com.ravenchat.Adapter.ListUserAdapter;
        ...
        btnCreateChat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (firstUser.getCheckedItemPositions().size() == 1)
                    ...
                    Toast.makeText(ListUsersActivity.this, "Selecciona algun contacto para chatear", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void createGroupChat(SparseBooleanArray checkedItemPositions) {
        ...
        QBRestChatService.createChatDialog(dialog).performAsync(new QBEntityCallback<QBChatDialog>() {
            ...
            public void onSuccess(QBChatDialog qbChatDialog, Bundle bundle) {
                mDialog.dismiss();
                Toast.makeText(getBaseContext(), "Chat creado con exito!", Toast.LENGTH_SHORT).show();
                finish();
            }
        ...
        for (int i=0; i<countChoice; i++){
            if (checkedItemPositions.get(i)){
                ...
                QBRestChatService.createChatDialog(dialog).performAsync(new QBEntityCallback<QBChatDialog>() {
                    ...
                    public void onSuccess(QBChatDialog qbChatDialog, Bundle bundle) {
                        mDialog.dismiss();
                        Toast.makeText(getBaseContext(), "Chat privado creado con exito!", Toast.LENGTH_SHORT).show();
